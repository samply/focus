...
pub(crate) fn replace_cql(decoded_library: impl Into<String>) -> String {
    let replace_map: HashMap<&str, &str> =
        [
            ...
            ("EXLIQUID_STRAT_DEF_IN_INITIAL_POPULATION_W_ALIQUOTS", "define InInitialPopulation: exists ExliquidSpecimenWithAliquot")
        ].into();
...
mod test {
    ...
    fn test_replace_cql() {
        ...
        let decoded_library = "EXLIQUID_CQL_W_ALIQUOTS";
        ...
        let decoded_library = "EXLIQUID_STRAT_DEF_IN_INITIAL_POPULATION_W_ALIQUOTS";
